...
{ /* Function scope starts here */
	...
	{/* New block scope starts here */
		int count1{ 10 };    // This is a new variable that hides the outer count1
	 ...
	 // std::cout << count4 << std::endl;    // count 4 does not exist in this scope.
